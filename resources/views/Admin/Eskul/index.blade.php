            ...
            <div class="collapse navbar-collapse text-center" id="navbarNav">
                <ul class="navbar-nav ms-auto ">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link active dropdown-toggle" href="#" data-bs-toggle="dropdown" style="font-size: 15px;">Data Eskul</a>
    ...
    <div class="card mx-auto custom-card">
        ...
        <table class="table table-bordered table-hover ">
            ...
            <tr>
              <td>1</td>
              <td>Basket Ball</td>
              <td>1 Minggu 3 kali pertemuan</td>
              <td>basket adalah olahraga yang sangat menyenangkan unutk di mainkan</td>
              <td>
                <a href="#">Edit</a>
                <a href="#">Hapus</a>
            </td>
            ...
            <tr>
              <td>2</td>
              <td>Batminton</td>
              <td>pertemuan di setiap hari sabtu</td>
              <td>batminton adalah olahraga yang sangat menyenangkan unutk di mainkan</td>
              <td>
                <a href="#">Edit</a>
                <a href="#">Hapus</a>
            </td>
