        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse text-center" id="navbarNav">
                <ul class="navbar-nav ms-auto ">
                    <li class="nav-item"><i class="fa-solid fa-house"></i><a class="nav-link active" href="{{ route('admin') }}" style="font-size: 15px;">Beranda</a></li>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" style="font-size: 15px;">Data Pengguna</a>
                        <ul class="dropdown-menu">
...
<div class="container mb-5">
    <div class="card mx-auto custom-card text-center ">
        <h4 class="card-title fw-semibold">Sistem Informasi Admin Eskul SMKN 1 Kawali</h4> <hr>
            <div class=" cardd d-flex justify-content-between">
                <div>
                    <h1 class="fw-semibold">0</h1>
                    <p class="fw-semibold">Eskul Yang Aktif</p>
                    <div class="image">
                        <img src="{{ asset('storage/img/logo.png') }}" class=" img-fluid" alt="">
                    </div>
                </div>
                <div>
                    <h1 class="fw-semibold">0</h1>
                    <p class="fw-semibold">Pembina Eskul</p>
                    <div class="image">
                        <img src="{{ asset('storage/img/logo.png') }}" class=" img-fluid" alt="">
                    </div>
                </div>
                <div>
                    <h1 class="fw-semibold">0</h1>
                    <p class="fw-semibold">Ketua Eskul</p>
                    <div class="image">
                        <img src="{{ asset('storage/img/logo.png') }}" class=" img-fluid" alt="">
                    </div>
                </div>
