        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse text-center" id="navbarNav">
                <ul class="navbar-nav ms-auto ">
                    <li class="nav-item"><a class="nav-link " href="{{ route('user') }}" style="font-size: 15px;">Beranda</a></li>
                    <li class="nav-item"><a class="nav-link active " href="{{ route('list.eskul') }}" style="font-size: 15px;">Eskul</a></li>
